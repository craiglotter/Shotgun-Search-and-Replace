...
Public Class Main_Screen
    ...
    Private Sub FolderRename(ByVal targetdir As String)
        Try
            If CancelOperation = False Then
                Dim dinfo As DirectoryInfo = New DirectoryInfo(targetdir)
                If dinfo.Exists = True Then
                    ...
                    If adjusted = False Then
                        newname = dinfo.Name.Replace(SSR_SearchTerm.Text, SSR_ReplaceTerm.Text)
                    ...
                    If SSR_TermModifierLowercase.Checked = True Then
                        If adjusted = False Then
                            newname = dinfo.Name.Replace(SSR_SearchTerm.Text.ToLower, SSR_ReplaceTerm.Text.ToLower)
                            If newname <> oldname Then
                                While My.Computer.FileSystem.DirectoryExists((dinfo.Parent.FullName.ToString & "\" & newname).Replace("\\", "\")) = True
                                    newname = newname & "_"
                                End While
                    ...
                    If SSR_TermModifierUppercase.Checked = True Then
                        If adjusted = False Then
                            newname = dinfo.Name.Replace(SSR_SearchTerm.Text.ToUpper, SSR_ReplaceTerm.Text.ToUpper)
                            If newname <> oldname Then
                                While My.Computer.FileSystem.DirectoryExists((dinfo.Parent.FullName.ToString & "\" & newname).Replace("\\", "\")) = True
                                    newname = newname & "_"
                                End While
                    ...
                    If SSR_TermModifierTitleCase.Checked = True Then
                        If adjusted = False Then
                            newname = dinfo.Name.Replace(Thread.CurrentThread.CurrentCulture.TextInfo.ToTitleCase(SSR_SearchTerm.Text), Thread.CurrentThread.CurrentCulture.TextInfo.ToTitleCase(SSR_ReplaceTerm.Text))
                            If newname <> oldname Then
                                While My.Computer.FileSystem.DirectoryExists((dinfo.Parent.FullName.ToString & "\" & newname).Replace("\\", "\")) = True
                                    newname = newname & "_"
                                End While
    ...
    Private Sub BackgroundWorker2_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker2.DoWork
        Try
            ...
            Else
                If My.Computer.FileSystem.DirectoryExists(SSR_RootFolder.Text) = True Then
                    FolderRename(SSR_RootFolder.Text)
                            ...
                            Else
                                ...
                                Try
                                    ...
                                    If finfo.Exists = True Then
                                        ...
                                        If adjusted = False Then
                                            newname = finfo.Name.Replace(SSR_SearchTerm.Text, SSR_ReplaceTerm.Text)
                                            If newname <> oldname Then
                                        ...
                                        If SSR_TermModifierLowercase.Checked = True Then
                                            If adjusted = False Then
                                                newname = finfo.Name.Replace(SSR_SearchTerm.Text.ToLower, SSR_ReplaceTerm.Text.ToLower)
                                                If newname <> oldname Then
                                                    While My.Computer.FileSystem.FileExists((finfo.DirectoryName.ToString & "\" & newname).Replace("\\", "\")) = True
                                                        newname = newname & "_"
                                                    End While
                                        ...
                                        If SSR_TermModifierUppercase.Checked = True Then
                                            If adjusted = False Then
                                                newname = finfo.Name.Replace(SSR_SearchTerm.Text.ToUpper, SSR_ReplaceTerm.Text.ToUpper)
                                                If newname <> oldname Then
                                                    While My.Computer.FileSystem.FileExists((finfo.DirectoryName.ToString & "\" & newname).Replace("\\", "\")) = True
                                                        newname = newname & "_"
                                                    End While
                                        ...
                                        If SSR_TermModifierTitleCase.Checked = True Then
                                            If adjusted = False Then
                                                newname = finfo.Name.Replace(Thread.CurrentThread.CurrentCulture.TextInfo.ToTitleCase(SSR_SearchTerm.Text), Thread.CurrentThread.CurrentCulture.TextInfo.ToTitleCase(SSR_ReplaceTerm.Text))
                                                If newname <> oldname Then
                                                    While My.Computer.FileSystem.FileExists((finfo.DirectoryName.ToString & "\" & newname).Replace("\\", "\")) = True
                                                        newname = newname & "_"
                                                    End While
        ...
        Try
            If CancelOperation = False Then
                ...
                If finfo.Exists = True Then
                    ...
                    While reader.Peek <> -1
                        lineread = reader.ReadLine
                        newlineread = lineread.Replace(SSR_SearchTerm.Text, SSR_ReplaceTerm.Text)
                        ...
                        If SSR_TermModifierLowercase.Checked = True Then
                            newlineread = lineread.Replace(SSR_SearchTerm.Text.ToLower, SSR_ReplaceTerm.Text.ToLower)
                            If lineread <> newlineread Then
                                filecontentsadjusted = True
                                Exit While
                            End If
                        ...
                        If SSR_TermModifierUppercase.Checked = True Then
                            newlineread = lineread.Replace(SSR_SearchTerm.Text.ToUpper, SSR_ReplaceTerm.Text.ToUpper)
                            If lineread <> newlineread Then
                                filecontentsadjusted = True
                                Exit While
                            End If
                        ...
                        If SSR_TermModifierTitleCase.Checked = True Then
                            newlineread = lineread.Replace(Thread.CurrentThread.CurrentCulture.TextInfo.ToTitleCase(SSR_SearchTerm.Text), Thread.CurrentThread.CurrentCulture.TextInfo.ToTitleCase(SSR_ReplaceTerm.Text))
                            If lineread <> newlineread Then
                                filecontentsadjusted = True
                                Exit While
                            End If
                    ...
                    If filecontentsadjusted = True Then
                        ...
                        While reader.Peek <> -1
                            ...
                            If SSR_TermModifierLowercase.Checked = True Then
                                newlineread = newlineread.Replace(SSR_SearchTerm.Text.ToLower, SSR_ReplaceTerm.Text.ToLower)
                            End If

                            If SSR_TermModifierUppercase.Checked = True Then
                                newlineread = newlineread.Replace(SSR_SearchTerm.Text.ToUpper, SSR_ReplaceTerm.Text.ToUpper)
                            End If

                            If SSR_TermModifierTitleCase.Checked = True Then
                                newlineread = newlineread.Replace(Thread.CurrentThread.CurrentCulture.TextInfo.ToTitleCase(SSR_SearchTerm.Text), Thread.CurrentThread.CurrentCulture.TextInfo.ToTitleCase(SSR_ReplaceTerm.Text))
                            End If
